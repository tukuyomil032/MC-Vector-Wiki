...
const cards = [
  {
    ...
    hrefs: ["/docs/getting-started/installation", "/docs/getting-started/server-creation"],
  },
  {
    ...
    linkKeys: ["serverLifecycle", "pluginsMods", "backupRestore", "fileManager", "consoleLogs"] as const,
    hrefs: [
  ...
  },
  {
    ...
    linkKeys: ["serverProperties", "themeCustomization", "generalSettings"] as const,
    hrefs: ["/docs/configuration/server-properties", "/docs/configuration/theme-customization", "/docs/configuration/general-settings"],
  },
  {
    ...
    hrefs: ["/docs/network-proxy/ngrok-tunnel", "/docs/network-proxy/velocity-setup"],
  },
  {
    ...
    hrefs: ["/docs/troubleshooting/common-errors", "/docs/troubleshooting/performance"],
  },
  {
            ...
            >
              ...
              <div className="relative m-[1.5px] rounded-[calc(1rem-1.5px)] bg-surface p-6 flex-1">
                <div className={`flex items-center gap-2 mb-4 ${card.color}`}>
                  ...
                  <h3 className="text-lg font-semibold text-white">{t.docs.cards[card.key]}</h3>
                </div>
